...
@app.get(
    ...
    description=(
        ...
        "Если просмотры совпадают, сначала показываются рецепты "
        "с меньшим временем приготовления."
    ),
)
...
@app.post(
    ...
    description=("Создаёт новый рецепт. " "Время приготовления передаётся в минутах."),
)
